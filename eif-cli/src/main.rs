...
//  from https://github.com/aws/aws-nitro-enclaves-image-format/commit/485fab0b37c1127347056f163c6cd0ae756f7cd0


#![deny(warnings)]
/// Simple utility tool for building an Eif file
///  eif_build -- --help  should be self explanatory.
/// Example of usage:
/// eif_build --target-dir=~/vmm-build -- --kernel bzImage \
    ...
    let matches = App::new("Enclave image format builder")
        ...
        .arg(
            Arg::with_name("arch")
                ...
                .help("Sets architecture to be used for measuring the image")
                .takes_value(true)
                .required(true)
                .takes_value(true),
        )
